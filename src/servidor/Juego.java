...
/**
 * La clase juego contiene la lista de usuarios, la puntuación de cada uno de esos usuarios, si el topo ha sido golpeado o no;
 * obtiene la cantidad de puntos necesarios para ganar;
 * Además, cuenta con los métodos de agregar jugador, borrar jugador, obtener puntuacion del jugador,
 * golpear al topo y obtener la posición del topo.
 */
public class Juego {
